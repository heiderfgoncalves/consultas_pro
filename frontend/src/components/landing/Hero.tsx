...
export function Hero({ activeStepIndex, setActiveStepIndex }: HeroProps) {
  ...
  return (
    <section className="relative py-12 md:py-16 overflow-hidden min-h-[75vh] flex items-center">
      ...
      <div className="absolute bottom-[-15%] left-[-10%] w-[500px] h-[500px] bg-pulse-glow pointer-events-none z-0 opacity-10 dark:opacity-45" style={{ animationDelay: "-4s", filter: "blur(100px)" }} />
      ...
      <div className="absolute top-0 right-6 w-[2px] h-full overflow-hidden pointer-events-none z-0 bg-hairline/20">
        <div className="scanning-line-secondary w-full" style={{ animationDelay: "-3.5s" }} />
      </div>
              ...
              if (componentId === "info") {
                return (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none opacity-[0.12] z-0 select-none">
                      <span className="mono text-[10px] tracking-[0.2em] text-brand uppercase">Módulo Informações</span>
                      <span className="mono text-[8px] tracking-widest text-muted-foreground mt-1">[ ANCORA_SLOT_0{i + 1} ]</span>
                    </div>
                    ...
                    >
                      <div className="flex flex-col items-start w-full">
                        <div className="inline-flex items-center gap-2.5 rounded-full border border-hairline bg-surface/40 px-3.5 py-1.5 backdrop-blur-xl shadow-[0_0_40px_-12px_var(--color-brand)] animate-glitch-hover cursor-pointer mb-6 cursor-target">
                          ...
                          <TextType
                            text={[
                              "Plataforma de consultas de crédito B2B",
                              "Motor de-para de dados heterogêneos agnóstico",
                              "Ledger de auditoria imutável integrado",
                              "Integração via SDK e widgets white-label"
                            ]}
                            typingSpeed={40}
                            pauseDuration={2800}
                            deletingSpeed={15}
                        ...
                        <div className="mt-10 flex flex-wrap items-center gap-x-4 gap-y-2 mono text-[10px] tracking-[0.15em] uppercase text-muted-foreground">
                          <span><span className="text-foreground font-semibold">40+</span> fornecedores</span>
                          <span className="text-hairline">•</span>
                          <span><span className="text-foreground font-semibold font-mono">9</span> tipos</span>
                          <span className="text-hairline">•</span>
                          <span><span className="text-foreground font-semibold font-mono">&lt;250ms</span> latência</span>
                        </div>
                      </div>
                    </InteractiveModularCard>
                  </div>
                ...
                return (
                  ...
                  >
                    {/* Etiqueta de Grid no fundo do slot */}
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none opacity-[0.12] z-0 select-none">
                      <span className="mono text-[10px] tracking-[0.2em] text-brand uppercase">Painel de Emissão</span>
                      <span className="mono text-[8px] tracking-widest text-muted-foreground mt-1">[ ANCORA_SLOT_0{i + 1} ]</span>
                    </div>
                    ...
                    >
                      <div className="magic-border-container rounded-md p-[1px] w-full">
                        <HUDFrame className="p-6 md:p-8 bg-card/94 backdrop-blur-md rounded-md shadow-2xl relative overflow-hidden">
                          ...
                          <div className="absolute inset-0 pointer-events-none z-0 opacity-10 bg-gradient-to-b from-transparent via-brand to-transparent h-[150px] animate-pulse" style={{ animationDuration: "3s" }} />
                          <PipelineCard activeStepIndex={activeStepIndex} setActiveStepIndex={setActiveStepIndex} />
                        </HUDFrame>
                      </div>
