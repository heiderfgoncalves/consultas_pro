...
export function BackgroundFX() {
  ...
  const isDark = resolvedTheme !== "light"; // default to dark if not explicit light
      ...
      <div
        ...
        style={{
          background: isDark
            ...
            : "radial-gradient(120% 80% at 50% -10%, oklch(0.92 0.03 250 / 0.65) 0%, transparent 55%), radial-gradient(80% 60% at 100% 110%, oklch(0.94 0.03 245 / 0.45) 0%, transparent 60%), var(--color-background)",
        }}
      />
        ...
        <motion.div
          ...
          style={{
            ...
            background: isDark
              ...
              : "radial-gradient(circle, oklch(0.75 0.12 250 / 0.35) 0%, transparent 65%)",
            filter: "blur(80px)",
          }}
        ...
        <motion.div
          ...
          style={{
            ...
            background: isDark
              ...
              : "radial-gradient(circle, oklch(0.8 0.1 235 / 0.25) 0%, transparent 65%)",
            filter: "blur(90px)",
          }}
        ...
        <motion.div
          ...
          style={{
            ...
            background: isDark
              ...
              : "radial-gradient(circle, oklch(0.75 0.12 265 / 0.22) 0%, transparent 65%)",
            filter: "blur(90px)",
          }}
      ...
      <motion.div
        ...
        style={{
          ...
          backgroundImage: isDark
            ...
            : "linear-gradient(to right, oklch(0 0 0 / 0.08) 1px, transparent 1px), linear-gradient(to bottom, oklch(0 0 0 / 0.08) 1px, transparent 1px)",
      ...
      <motion.div
        ...
        style={{
          ...
          backgroundImage: isDark
            ...
            : "repeating-linear-gradient(0deg, oklch(0 0 0 / 0.03) 0px, oklch(0 0 0 / 0.03) 1px, transparent 1px, transparent 3px)",
        }}
      />
