...
const lines = [
  ...
  { t: "10:00:10", tag: "FETCH", tagColor: "text-blue-600 dark:text-blue-300", msg: "Consultando 4 provedores em paralelo (SOLLOS, SERASA, BOA_VISTA, SCPC)..." },
  { t: "10:00:12", tag: "MAP", tagColor: "text-cyan-600 dark:text-cyan-300", msg: "Aplicando de-para FLAT → TEMPLATE (137 variáveis ativas)" },
  { t: "10:00:13", tag: "MATH", tagColor: "text-violet-600 dark:text-violet-300", msg: 'Resolvendo math("R$ 14.877,35" * 0.1) → 1487.735' },
  { t: "10:00:14", tag: "LEDGER", tagColor: "text-brand", msg: "Débito R$ 14,77 confirmado (locking pessimista OK)" },
