...
const ABA_PARAM: Record<'providers' | 'consultations' | 'types' | 'templates', string> = {
...
): 'providers' | 'consultations' | 'types' | 'templates' | null {
...
export function tabToIntegrationsAbaParam(tab: 'providers' | 'consultations' | 'types' | 'templates'): string {
  return ABA_PARAM[tab];
}

export function buildIntegrationsAdminUrl(tab: 'providers' | 'consultations' | 'types' | 'templates'): string {
