...
import { defaultTemplates, queryTypes, fixedBlocks, customBlocks } from "./mocks";
...
export const useActiveQuery = (): QueryType => useEditorStore((s) => queryTypes.find((q) => q.id === s.activeQueryId) ?? queryTypes[0]);
