...
> Version-aware guidance: validate the repo setup before applying v4-specific patterns.
...
- normal responsive prefixes (`sm:`, `md:`, `lg:`) and current utility conventions

Do not suggest migrating to v4 unless the user explicitly asks for that migration.
