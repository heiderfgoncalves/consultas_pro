...
### With CURSOR.md Rules

- **Priority**: CURSOR.md rules > intelligent-routing
- If CURSOR.md specifies explicit routing, follow it
...
**Next Steps**: Integrate this skill into CURSOR.md TIER 0 rules.
