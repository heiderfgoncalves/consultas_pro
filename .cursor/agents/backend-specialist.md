...
- Ler `.cursor/skills/uazapi-whatsapp-integration/SKILL.md` **alem** de `consultas-pro-backend-canonical`.
- Copiar/adaptar payloads: `uazapi-whatsapp-integration/examples.md`.
- Não carregar essa skill para tarefas backend genéricas sem relação com esse integrador.
