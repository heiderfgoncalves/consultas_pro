...
export function SplashScreen() {
  // Only show on the very first load of a session.
      ...
      {show && (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(60% 50% at 50% 50%, oklch(0.7 0.18 250 / 0.35) 0%, transparent 70%), var(--color-background)",
            }}
          />
          <motion.div
          ...
          >
            <div className="flex items-center gap-3 mono text-[13px] tracking-[0.24em] uppercase">
