        ...
        <FadeUp>
          <div className="relative overflow-hidden rounded-xl border border-hairline bg-surface/40 p-10 md:p-16 text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <a
                href="#"
                className="group inline-flex items-center gap-2 rounded-md bg-brand px-5 py-3 text-sm font-medium text-primary-foreground shadow-[0_0_40px_-6px_var(--color-brand)] hover:shadow-[0_0_60px_-2px_var(--color-brand)] transition-shadow"
              >
                Começar grátis
              ...
              <a
                href="#"
                className="inline-flex items-center gap-2 rounded-md border border-hairline bg-background/60 px-5 py-3 text-sm text-foreground hover:bg-surface transition-colors"
              >
                Falar com vendas
              </a>
            </div>
